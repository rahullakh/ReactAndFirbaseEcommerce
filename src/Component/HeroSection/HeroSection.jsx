...
const HeroSection = () => {
  ...
  if (!getAllProduct || getAllProduct.length === 0) {
    return <h2 className="text-center py-10">No Products Found</h2>;
  }

 
  const currentItem = getAllProduct[currentIndex] || getAllProduct[0];
  ...
  return (
    <section className="relative w-full min-h-[80vh] sm:min-h-[90vh] bg-gray-100 overflow-hidden flex items-center justify-center">
      <div className="w-full max-w-7xl flex flex-col lg:flex-row items-center justify-between bg-white rounded-md shadow-lg py-20 lg:py-14">
        ...
        <div className="flex-1 flex items-center justify-center w-full">
          <img
            ...
            className="w-[70%] sm:w-[60%] md:w-[55%] lg:w-[50%] max-h-[450px] object-contain rounded-md shadow-xl transition-all duration-500"
          />
        </div>
        ...
        <div className="flex-1 flex flex-col items-center lg:items-start justify-center p-6 sm:p-10">
          ...
          <button
            type="button"
            onClick={handleBuy}
            className="bg-[#31cd32] hover:bg-[#27ed27] mt-4 text-white px-5 py-2 rounded"
          >
            Buy Now
          </button>
        </div>
